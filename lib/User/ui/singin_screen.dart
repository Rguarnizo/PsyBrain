...
class SignInScreen extends StatefulWidget {
  ...
  _SignInScreenState createState() => _SignInScreenState();
    ...
    static void showDialogAlert(BuildContext context, String title, String content) {
    showDialog(
        context: context,
                ...
                child: Column(
                  ...
                  children: [
                    TextFormField(
                      validator: (value) {
                        value.isEmpty
                            ? SignInScreen.showDialogAlert(context, 'Campo vacío',
                    ...
                    MyButton(
                        ...
                        action: () {
                          ...
                          if (_email != '' && _password != '') {
                            ...
                            // showDialogAlert(context, result[0], result[1]);
                          }
