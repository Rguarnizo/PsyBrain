            ...
            Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  leading: Radio(value: 1, groupValue: selectedEdad, 
                  ...
                  leading: Radio(value: 2, groupValue: selectedEdad, 
                  ...
                  leading: Radio(value: 3, groupValue: selectedEdad, 
                  ...
                  leading: Radio(value: 4, groupValue: selectedEdad, 
                  ...
                  ListTile(
                  title: const Text('Si'),  
                  leading: Radio(value: 1, groupValue: selectedFisico, 
                  ...
                  ListTile(
                  title: const Text('No'),  
                  leading: Radio(value: 2, groupValue: selectedFisico, 
                  ...
                  leading: Radio(value: 3, groupValue: selectedFisico, 
                  
                    onChanged: (val){
                    setSelectedFisico(val);
                  }),
                  ),
                  Text('En las ultimas 4 semanas, ¿ Has tenido problemas con tu trabajo o vida diaria debido a cualquier problema emocional, como sentirse deprimido, triste o ansioso?'),
                  ListTile(
                  title: const Text('Si'),  
                  leading: Radio(value: 1, groupValue: selectedEmocional, 
                  ...
                  ListTile(
                  title: const Text('No'),  
                  leading: Radio(value: 2, groupValue: selectedEmocional, 
                  ...
                  ListTile(
                  title: const Text('No sabe'),  
                  leading: Radio(value: 3, groupValue: selectedEmocional, 
                  ...
                  leading: Radio(value: 1, groupValue: selectedCalificacionSaludMental, 
                  ...
                  leading: Radio(value: 2, groupValue: selectedCalificacionSaludMental, 
                  ...
                  leading: Radio(value: 3, groupValue: selectedCalificacionSaludMental, 
                  ...
                  leading: Radio(value: 4, groupValue: selectedCalificacionSaludMental, 
                  ...
                  leading: Radio(value: 5, groupValue: selectedCalificacionSaludMental, 
                  ...
                  leading: Radio(value: 6, groupValue: selectedCalificacionSaludMental, 
                  
                    onChanged: (val){
                    setSelectedCalificacionSaludMental(val);
                  }),
                  ),
                  Text('¿Te has sentido particularmente bajo de animo o triste por más de dos semanas?'),
                  ListTile(
                  title: const Text('Muy seguido'),  
                  leading: Radio(value: 1, groupValue: selectedTristeDosSemanas, 
                  ...
                  leading: Radio(value: 2, groupValue: selectedTristeDosSemanas, 
                  ...
                  leading: Radio(value: 3, groupValue: selectedTristeDosSemanas, 
                  ...
                  leading: Radio(value: 4, groupValue: selectedTristeDosSemanas, 
                  
                    onChanged: (val){
                    setSelectedTristeDosSemanas(val);
                  }),
                  ),
                  Text('Durante las ultimas dos semanas, ¿Qué tan seguido ha afectado tu salud mental a tus relaciones?'),
                  ListTile(
                  title: const Text('Muy seguido'),  
                  leading: Radio(value: 1, groupValue: selectedEfectoSalud, 
                  ...
                  ListTile(
                  title: const Text('Relativamente seguido'),  
                  leading: Radio(value: 2, groupValue: selectedEfectoSalud, 
                  ...
                  ListTile(
                  title: const Text('No tan seguido'),  
                  leading: Radio(value: 3, groupValue: selectedEfectoSalud, 
                  ...
                  ListTile(
                  title: const Text('Para nada'),  
                  leading: Radio(value: 4, groupValue: selectedEfectoSalud, 
                  
                    onChanged: (val){
                    setSelectedEfectoSalud(val);
                  }),
                  ),
                  Text('¿Has sido diagnosticado con un desorden mental en el pasado?'),
                  ListTile(
                  title: const Text('Si'),  
                  leading: Radio(value: 1, groupValue: selectedDiagnostico, 
                  ...
                  ListTile(
                  title: const Text('No'),  
                  leading: Radio(value: 2, groupValue: selectedDiagnostico, 
                  
                    onChanged: (val){
                    setSelectedDiagnostico(val);
                  }),
                  ),
                  Text('¿Cuándo fue la ultima vez que te realizaste un examén de salud mental?'),
                  ListTile(
                  title: const Text('Menos de seis meses'),  
                  leading: Radio(value: 1, groupValue: selectedUltimoExamen, 
                  ...
                  leading: Radio(value: 2, groupValue: selectedUltimoExamen, 
                  ...
                  leading: Radio(value: 3, groupValue: selectedUltimoExamen, 
                  ...
                  leading: Radio(value: 4, groupValue: selectedUltimoExamen, 
                  
                    onChanged: (val){
                    setSelectedUltimoExamen(val);
                  }),
                  ),
                  Text('¿Hay algún historial de desorden mental en tu familia?'),
                  ListTile(
                  title: const Text('Si'),  
                  leading: Radio(value: 1, groupValue: selectedHistorial, 
                  ...
                  ListTile(
                  title: const Text('No'),  
                  leading: Radio(value: 2, groupValue: selectedHistorial, 
                  
                    onChanged: (val){
                    setSelectedHistorial(val);
                  }),
                  ),
                  Text('¿Has visto a algún terapista en el pasado reciente?'),
                  ListTile(
                  title: const Text('Si'),  
                  leading: Radio(value: 1, groupValue: selectedPasadoReciente, 
                  ...
                  ListTile(
                  title: const Text('No'),  
                  leading: Radio(value: 2, groupValue: selectedPasadoReciente, 
                  ...
                  ListTile(
                  title: const Text('Si'),  
                  leading: Radio(value: 1, groupValue: selectedMedicacion, 
                  ...
                  ListTile(
                  title: const Text('No'),  
                  leading: Radio(value: 2, groupValue: selectedMedicacion, 
                  ...
                  leading: Radio(value: 1, groupValue: selectedHoras, 
                  ...
                  leading: Radio(value: 2, groupValue: selectedHoras, 
                  ...
                  leading: Radio(value: 3, groupValue: selectedHoras, 
                  ...
                  ListTile(
                  title: const Text('9+'),  
                  leading: Radio(value: 4, groupValue: selectedHoras, 
                  ...
                  leading: Radio(value: 1, groupValue: selectedCalidad, 
                  ...
                  leading: Radio(value: 2, groupValue: selectedCalidad, 
                  ...
                  leading: Radio(value: 3, groupValue: selectedCalidad, 
                  ...
                  leading: Radio(value: 4, groupValue: selectedCalidad, 
                  ...
                  leading: Radio(value: 5, groupValue: selectedCalidad, 
                  ...
                  leading: Radio(value: 1, groupValue: selectedMarital, 
                  ...
                  leading: Radio(value: 2, groupValue: selectedMarital, 
                  ...
                  leading: Radio(value: 3, groupValue: selectedMarital, 
                  ...
                  leading: Radio(value: 4, groupValue: selectedMarital, 
                  ...
                  leading: Radio(value: 5, groupValue: selectedMarital, 
                  ...
                  ListTile(
                  title: const Text('Si'),  
                  leading: Radio(value: 1, groupValue: selectedFumador, 
                  ...
                  ListTile(
                  title: const Text('No'),  
                  leading: Radio(value: 2, groupValue: selectedFumador, 
                  ...
                  ListTile(
                  title: const Text('Si'),  
                  leading: Radio(value: 1, groupValue: selectedAlcoholico, 
                  ...
                  ListTile(
                  title: const Text('No'),  
                  leading: Radio(value: 2, groupValue: selectedAlcoholico, 
                  
                    onChanged: (val){
                    setSelectedAlcoholico(val);
                  }),
                  ),
                  Text('¿Qué tan seguido te sientes positivo acerca de tu vida?'),
                  ListTile(
                  title: const Text('Nunca'),  
                  leading: Radio(value: 1, groupValue: selectedPositivismo, 
                  ...
                  leading: Radio(value: 2, groupValue: selectedPositivismo, 
                  ...
                  leading: Radio(value: 3, groupValue: selectedPositivismo, 
                  ...
                  leading: Radio(value: 4, groupValue: selectedPositivismo, 
                  ...
                  leading: Radio(value: 5, groupValue: selectedPositivismo, 
