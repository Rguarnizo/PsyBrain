...
class FireStoreApi {
  ...
  guardarEncuestaChat(Map<String, dynamic> jsonAfterChatPoll,String uid) {
    _apiFireStore.collection(USUARIO).doc(uid).collection('Encuesta Chat').add(jsonAfterChatPoll);
  }
